...
const headerData = {
  ...
  imageThumb: "/images/rahul-crop-70.png",
  social: {
    facebook: "https://facebook.com",
    twitter: "https://twitter.com/gkrahul1310",
    instagram: "https://www.instagram.com/rahulgaikwad1591/",
    youtue: "https://www.youtube.com/channel/UCs-iU6ENE1p3jpgot6HBvKQ",
    dribbble: "https://dribbble.com/rahulgaikwad",
  },
};
        ...
        <div className="header-inner d-flex align-items-start flex-column">
          ...
          <div className="footer mt-auto">
            ...
            <span className="copyright">
              &copy; {new Date().getFullYear()} Rahul Portfolio
            </span>
          </div>
        </div>
      </header>
